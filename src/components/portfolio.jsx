...
const Port = () =>{
    ...
    return(
            ...
            <div className="about"><br/><br/>
                ...
                <div className="row a11">
                    ...
                    <div className="image-wrapper1">
                        <img src="../edisan.jpg" alt="Your Image" style={{ transformOrigin: `${position.x * 100}% ${position.y * 100}%` }} /></div>
                     </div>
                    </div>
                    <div className="col-7">
      ...
      <img src='../backery.png' className='w-100' />
    ...
    <section id="contact">
        ...
        <h2 className="a3">Contact <span>Us</span></h2><br/>
            ...
            <div className="col-4 a12">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15697.925625386833!2d78.7898292445985!3d10.38328633587952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b00782d25029679%3A0x4503e2d3b4a3897f!2z4K6q4K-B4K6k4K-B4K6V4K-N4K6V4K-L4K6f4K-N4K6f4K-ILCDgrqTgrq7grr_grrTgr40g4K6o4K6-4K6f4K-BIDYyMjAwMw!5e0!3m2!1sta!2sin!4v1719571039827!5m2!1sta!2sin" width="600" height="450" style={{border:'0'}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
